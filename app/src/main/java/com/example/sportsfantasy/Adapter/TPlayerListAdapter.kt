...
class TPlayerListAdapter(private val context: Context, private val playerlist: MutableList<Player>, val playerListner: PlayerListner? = null) : RecyclerView.Adapter<TPlayerListAdapter.MyViewHolder>()
{
