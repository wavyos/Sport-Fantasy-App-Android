...
class pfPlayerNameAdapter(private val context: Context, private val playerAllData:ArrayList<PositionPF>) : RecyclerView.Adapter<pfPlayerNameAdapter.MyViewHolder>()
{
