...
class cPlayerNameAdapter(private val context: Context, private val playerAllData:ArrayList<PositionC>) : RecyclerView.Adapter<cPlayerNameAdapter.MyViewHolder>()
{
