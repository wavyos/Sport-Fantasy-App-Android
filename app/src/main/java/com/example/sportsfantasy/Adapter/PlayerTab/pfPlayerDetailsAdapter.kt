...
class pfPlayerDetailsAdapter(private val context: Context, private val playerData:ArrayList<PositionPF>) : RecyclerView.Adapter<pfPlayerDetailsAdapter.MyViewHolder>()
{
