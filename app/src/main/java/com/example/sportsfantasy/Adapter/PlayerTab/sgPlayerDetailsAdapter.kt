...
class sgPlayerDetailsAdapter(private val context: Context, private val playerData:ArrayList<PositionSG>) : RecyclerView.Adapter<sgPlayerDetailsAdapter.MyViewHolder>()
{
