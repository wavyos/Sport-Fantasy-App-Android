...
class pgPlayerDetailsAdapter(private val context: Context, private val playerData:ArrayList<PositionPG>) : RecyclerView.Adapter<pgPlayerDetailsAdapter.MyViewHolder>()
{
