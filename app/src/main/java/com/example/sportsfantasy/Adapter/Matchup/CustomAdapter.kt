...
import com.example.sportsfantasy.Model.Matchup_Test.PlayerNameModel
import com.example.sportsfantasy.R

class CustomAdapter(private val mList: List<PlayerNameModel>) : RecyclerView.Adapter<CustomAdapter.ViewHolder>() {
