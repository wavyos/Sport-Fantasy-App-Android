...
class cPlayerDetailsAdapter(private val context: Context, private val playerData:ArrayList<PositionC>) : RecyclerView.Adapter<cPlayerDetailsAdapter.MyViewHolder>()
{
    class MyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView)
    {
        val tv_position_type = itemView.findViewById<TextView>(R.id.tv_positiontype)
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) 
    {
        ...
        holder.tv_position_type.visibility = View.GONE
