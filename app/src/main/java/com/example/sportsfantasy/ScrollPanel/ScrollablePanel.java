...
public class ScrollablePanel extends FrameLayout {
     ...
     */
    private static class PanelLineItemAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private static class PanelLineAdapter extends RecyclerView.Adapter<PanelLineAdapter.ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ViewHolder viewHolder = new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.listitem_content_row, parent, false));
